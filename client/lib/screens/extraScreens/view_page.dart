import 'package:client/screens/extraScreens/confirmPage.dart';
...
class _ViewPageState extends State<ViewPage> {
  ...
  Future<Map<String, dynamic>> _fetchHouseData() async {
    ...
    final houseData = doc.data()!;
    _agentData = _fetchAgentData(houseData['agentID']);
    return houseData;
  }

  Future<Map<String, dynamic>> _fetchAgentData(String agentID) async {
    ...
    return Scaffold(
      body: FutureBuilder<Map<String, dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          final houseID = houseData['houseID'] as String;
                    ...
                    children: [
                      ...
                      FutureBuilder<Map<String, dynamic>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final profileImage = agentData['profileImage'] ?? '';
                          final firstName =
                              agentData['firstName'] as String? ?? '';
                          final lastName =
                              agentData['lastName'] as String? ?? '';
                          final rating = agentData['rating'] as double? ?? 5.0;
                          ...
                          return Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(
                                    height:
                                        16), // Add spacing between agent details and buttons
                                // Buttons Row
                                Row(
                                  mainAxisAlignment:
