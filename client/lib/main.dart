import 'package:client/screens/Authetication/loginScreen.dart';
import 'package:client/screens/themes/theme_provider.dart';
import 'package:client/screens/widgets/bottom_navbar.dart';
  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: FirebaseOptions(
          ...
          appId: "1:37507938700:web:53c560dbc2450626f83ea9",
          measurementId: "G-SWD6DCTYGX"),
    );
  } else {
    await Firebase.initializeApp();
  }
